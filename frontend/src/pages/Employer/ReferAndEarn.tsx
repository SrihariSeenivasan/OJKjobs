...
const ReferAndEarn = () => {
  ...
  return (
    <div className="bg-[#fffbe6] min-h-screen py-8 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Earn up to 2500 Database credits for FREE</h1>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
              ...
              <div className="flex gap-2 mb-4 flex-wrap">
                ...
                <button className={`bg-green-700 hover:bg-green-800 text-white rounded px-4 py-2 font-semibold flex items-center gap-2 ${copied ? 'bg-green-900' : ''}`} onClick={handleCopy}>
                  {copied ? 'Copied!' : 'Copy link'}
                </button>
                <button className="bg-green-50 border border-green-700 text-green-700 rounded px-2 py-2 font-semibold" title="Share on WhatsApp" onClick={() => handleShare('whatsapp')}>
                ...
                <button className="bg-blue-50 border border-blue-700 text-blue-700 rounded px-2 py-2 font-semibold" title="Share on Facebook" onClick={() => handleShare('facebook')}>
                ...
                <button className="bg-blue-50 border border-blue-700 text-blue-700 rounded px-2 py-2 font-semibold" title="Share on LinkedIn" onClick={() => handleShare('linkedin')}>
              ...
              <div className="flex gap-2 mb-2 flex-wrap">
                ...
                <button className="bg-gray-100 border border-gray-400 text-gray-700 rounded px-4 py-2 font-semibold flex items-center gap-2" onClick={handleSend}>
              ...
              <div className="flex items-center gap-2 mb-1">
                <svg width="24" height="24" fill="none" stroke="#253858" strokeWidth="2" viewBox="0 0 24 24"><ellipse cx="12" cy="12" rx="10" ry="10" fill="#e5e7eb"/><ellipse cx="12" cy="12" rx="8" ry="8" fill="#fff"/><path d="M8 15c.5-1 1.5-2 4-2s3.5 1 4 2" stroke="#253858" strokeWidth="1.5"/><circle cx="9.5" cy="10" r="1" fill="#253858"/><circle cx="14.5" cy="10" r="1" fill="#253858"/></svg>
                <span className="text-2xl font-bold text-[#253858]">0</span>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6 mt-6">
              ...
              <div className="flex flex-col items-center justify-center py-8">
                <div className="flex gap-2 mb-2">
                  <span className="inline-block w-10 h-10 rounded-full bg-blue-100" />
                  <span className="inline-block w-10 h-10 rounded-full bg-pink-100" />
                  <span className="inline-block w-10 h-10 rounded-full bg-yellow-100" />
                </div>
          ...
          <div className="w-full md:w-80 flex-shrink-0">
            <div className="bg-white rounded-xl shadow-sm border p-6 mb-4">
              <div className="font-semibold mb-2">It is easy to earn with referrals</div>
              <ul className="text-gray-700 text-sm mb-2 space-y-2">
                <li className="flex items-center gap-2"><svg width="18" height="18" fill="none" stroke="#15803d" strokeWidth="2" viewBox="0 0 24 24"><circle cx="9" cy="7" r="4"/><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/></svg> Invite your friends from other companies with a unique referral link</li>
                <li className="flex items-center gap-2"><svg width="18" height="18" fill="none" stroke="#15803d" strokeWidth="2" viewBox="0 0 24 24"><circle cx="9" cy="7" r="4"/><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/></svg> When your friends join apna, they'll get <b>50 Database credits</b> on their first job activation.</li>
                <li className="flex items-center gap-2"><svg width="18" height="18" fill="none" stroke="#15803d" strokeWidth="2" viewBox="0 0 24 24"><circle cx="9" cy="7" r="4"/><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2"/></svg> Once your friend's first job is activated, you'll earn <b>100 Database credits</b> for free</li>
              </ul>
              <a href="#" className="text-blue-700 underline text-xs">Terms & conditions apply</a>
            </div>

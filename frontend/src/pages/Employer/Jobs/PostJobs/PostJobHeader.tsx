  ...
  return (
    <div className="w-full flex items-center justify-between px-8 pt-6 pb-2 bg-[#2D2346] border-b border-[#E5E7EB] shadow-sm">
      <div className="flex items-center gap-3">
        <button
          className="p-2 rounded-full hover:bg-[#453A5A] transition-colors"
          aria-label="Back"
          onClick={() => navigate(-1)}
        >
      ...
      <div className="flex items-center gap-6">
        <button
          className="flex items-center gap-1 text-[#A0AEC0] text-sm font-medium"
          aria-label="Support"
          onClick={() => navigate("/Employer/SupportHome")}
        >

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        <button className="absolute top-4 right-4 text-gray-500 hover:text-gray-700" onClick={onClose} aria-label="Close">
          &times;
        </button>
        <h2 className="text-lg font-semibold mb-4">Make a suggestion</h2>
        <label className="block text-sm font-medium mb-2">Company Logo</label>
        <div className="border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center py-8 mb-2 cursor-pointer">
          <svg width="32" height="32" fill="none" viewBox="0 0 24 24" className="mb-2 text-gray-400"><path d="M12 5v14m7-7H5" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round"/></svg>
          <span className="text-green-700 font-medium">Upload a photo</span>
        </div>
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button className="px-4 py-2 rounded bg-gray-300 text-gray-400 cursor-not-allowed" disabled>Submit</button>
        </div>
      </div>
    </div>
  );
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1 flex items-center gap-2"><svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-7 19h-3v-7h3v7zm-1.5-8.25c-.97 0-1.75-.78-1.75-1.75s.78-1.75 1.75-1.75 1.75.78 1.75 1.75-.78 1.75-1.75 1.75zm10.5 8.25h-3v-3.5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v3.5h-3v-7h3v1.08c.41-.63 1.17-1.08 2-1.08 1.66 0 3 1.34 3 3v4z" fill="#0A66C2"/></svg>LinkedIn</label>
            <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="https://linkedin.com/company/companyname" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1 flex items-center gap-2"><svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.733 0-1.325.592-1.325 1.325v21.351c0 .732.592 1.324 1.325 1.324h21.351c.732 0 1.324-.592 1.324-1.324v-21.351c0-.733-.592-1.325-1.324-1.325zm-13.538 19h-3v-7h3v7zm-1.5-8.25c-.97 0-1.75-.78-1.75-1.75s.78-1.75 1.75-1.75 1.75.78 1.75 1.75-.78 1.75-1.75 1.75zm10.5 8.25h-3v-3.5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v3.5h-3v-7h3v1.08c.41-.63 1.17-1.08 2-1.08 1.66 0 3 1.34 3 3v4z" fill="#1877F2"/></svg>Facebook</label>
            <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="https://facebook.com/username" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1 flex items-center gap-2"><svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.849.07 1.366.062 2.633.334 3.608 1.309.975.975 1.247 2.242 1.309 3.608.058 1.265.07 1.645.07 4.849s-.012 3.584-.07 4.849c-.062 1.366-.334 2.633-1.309 3.608-.975.975-2.242 1.247-3.608 1.309-1.265.058-1.645.07-4.849.07s-3.584-.012-4.849-.07c-1.366-.062-2.633-.334-3.608-1.309-.975-.975-1.247-2.242-1.309-3.608-.058-1.265-.07-1.645-.07-4.849s.012-3.584.07-4.849c.062-1.366.334-2.633 1.309-3.608.975-.975 2.242-1.247 3.608-1.309 1.265-.058 1.645-.07 4.849-.07zm0-2.163c-3.259 0-3.667.012-4.947.07-1.276.058-2.687.326-3.678 1.317-.991.991-1.259 2.402-1.317 3.678-.058 1.28-.07 1.688-.07 4.947s.012 3.667.07 4.947c.058 1.276.326 2.687 1.317 3.678.991.991 2.402 1.259 3.678 1.317 1.28.058 1.688.07 4.947.07s3.667-.012 4.947-.07c1.276-.058 2.687-.326 3.678-1.317.991-.991 1.259-2.402 1.317-3.678.058-1.28.07-1.688.07-4.947s-.012-3.667-.07-4.947c-.058-1.276-.326-2.687-1.317-3.678-.991-.991-2.402-1.259-3.678-1.317-1.28-.058-1.688-.07-4.947-.07z" fill="#E1306C"/><path d="M12 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zm0 10.162a3.999 3.999 0 1 1 0-7.998 3.999 3.999 0 0 1 0 7.998zm6.406-11.845a1.44 1.44 0 1 0 0 2.88 1.44 1.44 0 0 0 0-2.88z" fill="#E1306C"/></svg>Instagram</label>
            <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="https://instagram.com/username" />
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        ...
        <select className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-2">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        <button className="absolute top-4 right-4 text-gray-500 hover:text-gray-700" onClick={onClose} aria-label="Close">&times;</button>
        <h2 className="text-lg font-semibold mb-4">Make a suggestion</h2>
        <label className="block text-sm font-medium mb-2">Type of company</label>
        <select className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-2">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        ...
        <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-2" placeholder="e.g. https://company.com" />
        <div className="flex justify-end gap-2 mt-4">
          <button className="px-4 py-2 rounded bg-gray-100 text-gray-700" onClick={onClose}>Cancel</button>
          <button className="px-4 py-2 rounded bg-green-700 text-white">Submit</button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
        ...
        <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2 mb-2" placeholder="e.g. Bot Digital Solutions Private Limited" />
        <div className="flex justify-end gap-2 mt-4">
          <button className="px-4 py-2 rounded bg-gray-100 text-gray-700" onClick={onClose}>Cancel</button>
          <button className="px-4 py-2 rounded bg-green-700 text-white">Submit</button>
        </div>

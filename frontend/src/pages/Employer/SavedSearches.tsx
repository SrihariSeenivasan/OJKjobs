        ...
        <section className="flex-1 min-w-0">
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-96">
              ...
              <button className="bg-green-600 hover:bg-green-700 text-white rounded px-4 py-2 font-semibold" onClick={() => navigate('/EmployerLayout/SearchCandidates')}>Go to search page</button>
            </div>
          ) : (
            <div>

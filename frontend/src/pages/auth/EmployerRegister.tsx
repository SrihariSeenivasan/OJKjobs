    ...
    <div className="w-full max-w-md mx-auto">
      <div className="p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-blue-700">Employer Registration</h2>
          <p className="text-gray-500 text-sm mt-1">Register to post jobs and manage candidates</p>
        </div>
